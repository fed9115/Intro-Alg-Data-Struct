...
/**
 * This class checks to see how well an RNG works. It reports on several
 * important properties, including the following: the number of zeros after 1000
 * tries how many tries before all the numbers between 1-1000 are generated the
 * number of unique numbers generated in 1000 tries the number of odd-even pairs
 * the number of odd-odd pairs the number of even-odd pairs the number of
 * even-even pairs the average number generated
 * 
 * @author Erin Parker
...
public class CheckRandomNumberGenerator {
	...
	public void checkRandom(RandomNumberGenerator generator, int seed) {
		...
		if (numbersFilled < maxSize) {
			...
			System.out.println("It took " + numbersGenerated + " generated numbers to hit every possibility from 0 to "
					+ maxSize + ".");
	}
	 ...
	 * @return true if setting the seed to the same value returns the same sequence,
	 *         false otherwise
	 */
	...
	/**
	 * Determines how many numbers need to be generated before an array of "maxSize"
	 * is filled.
	 * 

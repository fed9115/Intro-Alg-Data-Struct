...
public class HashTableTimingStudentMediumHash {

	public static void main(String[] args) {
		int timesToLoop = 10000;
		long startTime, midTime, stopTime;
		for (int n = 1000; n <= 20000; n += 1000) {
			HashTable<StudentMediumHash, Double> hashT = new HashTable<>();
			ArrayList<StudentMediumHash> arrListStudents = new ArrayList<>();
			...
			for (int i = 0; i < timesToLoop; i++) {
				//StudentMediumHash randStudent = arrListStudents.get(rng.nextInt(n));

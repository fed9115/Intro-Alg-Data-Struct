...
public class HashTableTimingStudentBadHash {

	public static void main(String[] args) {
		int timesToLoop = 10000;
		long startTime, midTime, stopTime;
		for (int n = 1000; n <= 20000; n += 1000) {
			HashTable<StudentBadHash, Double> hashT = new HashTable<>();
			ArrayList<StudentBadHash> arrListStudents = new ArrayList<>();
			...
			for (int i = 0; i < timesToLoop; i++) {
				//StudentBadHash randStudent = arrListStudents.get(rng.nextInt(n));
